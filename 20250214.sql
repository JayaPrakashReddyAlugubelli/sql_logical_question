#Q. write a SQL query to find the percentage of immediate orders --in the first orders of all customers, rounded to 2 decimal places. Note: order_date and delivery date same is called immediate order
